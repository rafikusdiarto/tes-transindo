...
class ProfileController extends Controller
{
    public function index($id)
    {
        try {
            ...
            // dd($user);
            return view('merchant.pages.profile.index', [
                'getUser' => $user
            ]);
        } catch (\Throwable $th) {
    ...
    public function changeStatus(Request $request, $id)
    {
        try {
            ...
            $message = ($request->status == 'AVAILABLE') ? 'Merchant is already open 😎' : 'We appreciate your hard work. The merchant is currently unavailable 😊';
